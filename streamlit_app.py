"""
SOC Dashboard - Point d'entrée principal pour Streamlit Cloud
...
def main():
    ...
    if page_name == "dashboard":
        ...
        from streamlit_app.pages.threats import show_threats
        show_threats()
    elif page_name == "network":
        from streamlit_app.pages.network import show_network
        show_network()
    elif page_name == "vulns":
        from streamlit_app.pages.vulns import show_vulns
        show_vulns()
    elif page_name == "incidents":
        from streamlit_app.pages.incidents import show_incidents
        show_incidents()
    elif page_name == "logs":
        from streamlit_app.components.log_viewer import show_log_viewer
        show_log_viewer()
    elif page_name == "admin":
        from streamlit_app.pages.admin import show_admin
        show_admin()
